...
const ECHO_IMAGE_QUIZ: {
  ...
  // ─── A4C view identification ───
  { imageCategory: 'a4c', question: 'What standard echocardiographic view is shown?', options: ['Apical 4-Chamber (A4C)', 'Parasternal Long Axis (PLAX)', 'Parasternal Short Axis (PSAX)', 'Subcostal 4-Chamber'], correct: 0, explanation: '**Apical 4-Chamber (A4C):** Probe at the apex, marker toward patient\'s left. Shows all 4 chambers.', echoKey: 'A4C assesses LV/RV size, MV/TV function, atrial sizes, and global systolic function.' },
  { imageCategory: 'a4c', question: 'In the A4C view, which valve sits more apically (closer to the apex)?', options: ['Tricuspid Valve', 'Mitral Valve', 'Aortic Valve', 'Both at same level'], correct: 0, explanation: '**Tricuspid Valve:** The TV inserts ~1 cm more apically than the MV — this apical offset distinguishes TV from MV.', echoKey: 'Apical offset also identifies Ebstein anomaly (TV displacement ≥8 mm/m² from MV).' },
  { imageCategory: 'a4c', question: 'In the A4C view, the left ventricle is normally on which side of the screen?', options: ['Right side', 'Left side', 'Top', 'Bottom'], correct: 0, explanation: '**Right side of screen:** By convention, A4C displays LV on the viewer\'s right and RV on the left. Apex at top.', echoKey: 'Verify orientation using the apical offset of the TV.' },
  { imageCategory: 'a4c', question: 'Which Doppler assessment is primarily obtained from the A4C view?', options: ['Mitral inflow E/A ratio', 'Aortic valve gradient', 'Pulmonic valve velocity', 'Descending aorta flow'], correct: 0, explanation: '**Mitral inflow E/A:** PW Doppler at the MV tips gives E and A wave velocities for diastolic function.', echoKey: 'E/A >2.0 = restrictive. E/A <0.8 = impaired relaxation. E/A 0.8–2.0 = indeterminate.' },
  { imageCategory: 'a4c', question: 'In the A4C, which valve separates the left atrium from the left ventricle?', options: ['Mitral Valve', 'Tricuspid Valve', 'Aortic Valve', 'Pulmonic Valve'], correct: 0, explanation: '**Mitral Valve (MV):** Separates LA from LV. Has anterior and posterior leaflets. MV sits slightly more basal than the TV.', echoKey: 'MV assessment: leaflet morphology, coaptation, regurgitation jet direction, and annular dimensions.' },
  { imageCategory: 'a4c', question: 'What is the normal RV:LV basal diameter ratio in the A4C view?', options: ['<0.6', '>1.0', '1.5:1', '2:1'], correct: 0, explanation: '**RV:LV <0.6:** The RV is normally about ⅔ the size of the LV. RV:LV >1.0 = significant RV dilation.', echoKey: 'RV basal diameter >4.2 cm = dilated. Causes: PE, pulm HTN, ARVC, severe TR.' },
  { imageCategory: 'a4c', question: 'In the A4C view, RV free wall akinesis with preserved apical contractility is called:', options: ['McConnell sign', 'D-sign', 'SAM', 'E-point septal separation'], correct: 0, explanation: '**McConnell sign:** Pathognomonic for acute pulmonary embolism. RV free wall akinesis with sparing of the RV apex.', echoKey: 'Sensitivity 77%, specificity 94% for PE. Also look for RV dilation, TR, and septal bowing.' },
  { imageCategory: 'a4c', question: 'What echo finding suggests elevated left atrial pressure?', options: ['LA dilation', 'RV dilation', 'Aortic root dilation', 'Thick IVS'], correct: 0, explanation: '**LA dilation:** LA volume index >34 mL/m² indicates chronically elevated LA pressure (diastolic dysfunction, MR, MS, A-fib).', echoKey: 'LA volume by biplane area-length method from A4C + A2C. LA >34 mL/m² = dilated.' },
  { imageCategory: 'a4c', question: 'TAPSE is measured in which view?', options: ['A4C', 'PLAX', 'PSAX', 'Suprasternal'], correct: 0, explanation: '**A4C:** Tricuspid Annular Plane Systolic Excursion measures RV longitudinal function via M-Mode at the lateral tricuspid annulus.', echoKey: 'TAPSE <17 mm = RV systolic dysfunction. Quick, reproducible, angle-dependent.' },
  { imageCategory: 'a4c', question: 'How is LV ejection fraction most accurately measured on echo?', options: ['Biplane Simpson method (A4C + A2C)', 'Visual estimation', 'M-Mode fractional shortening', 'E-point septal separation'], correct: 0, explanation: '**Biplane Simpson (MOD):** Trace LV endocardium in A4C and A2C at end-diastole and end-systole. Gold standard 2D echo method.', echoKey: 'Normal EF: 52–72% (men), 54–74% (women). Mildly reduced 41–51%, moderately 30–40%, severely <30%.' },
  // ─── Pericardial effusion ───
  { imageCategory: 'effusion', question: 'The anechoic (dark) space surrounding the heart most likely represents:', options: ['Pericardial Effusion', 'Pleural Effusion', 'Normal Pericardial Fat', 'Myocardial Edema'], correct: 0, explanation: '**Pericardial Effusion:** Fluid appears anechoic and wraps around the heart. Large effusions (>2 cm) can cause tamponade.', echoKey: 'Trivial <0.5 cm, small 0.5–1 cm, moderate 1–2 cm, large >2 cm. Assess IVC and RV for tamponade.' },
  { imageCategory: 'effusion', question: 'Which echo finding is most specific for cardiac tamponade?', options: ['RV diastolic collapse', 'Pericardial effusion', 'Tachycardia', 'LV dilation'], correct: 0, explanation: '**RV diastolic collapse:** The RV free wall collapses inward during diastole due to elevated intrapericardial pressure exceeding RV diastolic pressure.', echoKey: 'Tamponade signs: RV diastolic collapse, RA systolic collapse >⅓ cycle, plethoric IVC, respiratory variation >25%.' },
  { imageCategory: 'effusion', question: 'How do you differentiate pericardial from pleural effusion on echo?', options: ['Pericardial tracks anterior to descending aorta', 'Pericardial is always larger', 'Pleural is always bilateral', 'They look identical'], correct: 0, explanation: '**Anterior to descending aorta:** Pericardial fluid tracks between the heart and the descending aorta in PLAX. Pleural fluid tracks posterior to the aorta.', echoKey: 'In A4C: pericardial = circumferential. Pleural = posterior/lateral only, doesn\'t cross midline posteriorly.' },
  { imageCategory: 'effusion', question: 'A plethoric IVC (>2.1 cm, <50% collapse) in the setting of pericardial effusion suggests:', options: ['Cardiac tamponade physiology', 'Normal hemodynamics', 'Hypovolemia', 'Aortic stenosis'], correct: 0, explanation: '**Tamponade physiology:** Plethoric IVC indicates elevated RA pressure. Combined with effusion and clinical signs, this strongly suggests tamponade.', echoKey: 'IVC plethora has 97% sensitivity for elevated RAP. Always correlate with clinical picture.' },
  { imageCategory: 'effusion', question: 'What is the most sensitive echo sign of cardiac tamponade?', options: ['RA systolic collapse', 'RV diastolic collapse', 'LV dysfunction', 'Aortic valve calcification'], correct: 0, explanation: '**RA systolic collapse:** The RA wall indents during ventricular systole. More sensitive (but less specific) than RV diastolic collapse.', echoKey: 'RA collapse >⅓ of cardiac cycle = highly specific. RA collapse <⅓ cycle = sensitive but less specific.' },
  { imageCategory: 'effusion', question: 'In a patient with pericardial effusion, what does >25% respiratory variation in mitral inflow velocity suggest?', options: ['Hemodynamic compromise (tamponade)', 'Normal physiology', 'Aortic regurgitation', 'Mitral stenosis'], correct: 0, explanation: '**Tamponade:** Exaggerated respiratory variation (>25% mitral, >40% tricuspid) reflects ventricular interdependence from elevated intrapericardial pressure.', echoKey: 'Also called pulsus paradoxus on echo. Respiratory variation is the Doppler equivalent of clinical pulsus paradoxus.' },
  // ─── General echo knowledge (shown with random A4C images) ───
  { imageCategory: 'a4c', question: 'What does EPSS stand for and what does it estimate?', options: ['E-point septal separation — LV ejection fraction', 'Early peak systolic strain — RV function', 'End-point systolic shortening — valve area', 'Estimated pulmonary systolic stress — PA pressure'], correct: 0, explanation: '**E-point septal separation:** Distance from the MV E-point to the septum on M-Mode. EPSS >7 mm suggests EF <50%.', echoKey: 'Quick bedside estimate. EPSS >10 mm = severely reduced EF. Limited by MS, AR, and LV remodeling.' },
  { imageCategory: 'a4c', question: 'What is the normal interventricular septal thickness at end-diastole?', options: ['0.6–1.1 cm', '1.5–2.0 cm', '2.5–3.0 cm', '<0.3 cm'], correct: 0, explanation: '**0.6–1.1 cm:** IVSd >1.1 cm suggests LVH. IVSd ≥1.5 cm raises concern for HCM (≥1.3 cm with family history).', echoKey: 'Measure at end-diastole in PLAX M-Mode. Concentric LVH: IVS and PW both thick. Eccentric: dilation without thick walls.' },
  { imageCategory: 'a4c', question: 'What is the significance of systolic anterior motion (SAM) of the mitral valve?', options: ['LVOT obstruction in HOCM', 'Normal variant', 'Mitral stenosis', 'Tricuspid regurgitation'], correct: 0, explanation: '**LVOT obstruction in HOCM:** The anterior MV leaflet is pulled toward the septum during systole by the Venturi effect, causing dynamic LVOT obstruction and MR.', echoKey: 'SAM + LVOT gradient >30 mmHg at rest = obstructive HCM. Provocable with Valsalva, standing, or exercise.' },
  { imageCategory: 'a4c', question: 'What view is obtained by tilting the A4C probe anteriorly to include the aortic valve?', options: ['Apical 5-Chamber (A5C)', 'Apical 2-Chamber (A2C)', 'Apical 3-Chamber (A3C)', 'Subcostal view'], correct: 0, explanation: '**Apical 5-Chamber (A5C):** Anterior tilt from A4C brings the LVOT and AV into view. The "5th chamber" is the LVOT/aortic root.', echoKey: 'A5C is used for LVOT VTI (PW Doppler) and AV assessment (CW Doppler). Essential for cardiac output calculation.' },
  { imageCategory: 'a4c', question: 'What view is obtained by rotating 60° counterclockwise from the A4C?', options: ['Apical 2-Chamber (A2C)', 'Apical 5-Chamber (A5C)', 'Apical 3-Chamber (A3C)', 'Subcostal view'], correct: 0, explanation: '**Apical 2-Chamber (A2C):** Shows only LA and LV with anterior and inferior walls. No RV or RA. Used for biplane Simpson EF.', echoKey: 'A2C + A4C biplane Simpson method is the gold standard for EF measurement.' },
  { imageCategory: 'a4c', question: 'How is cardiac output calculated using echo?', options: ['LVOT VTI × LVOT area × heart rate', 'E/A ratio × heart rate', 'EF × LV volume', 'TAPSE × RV area'], correct: 0, explanation: '**CO = SV × HR, where SV = LVOT VTI × LVOT area.** LVOT diameter measured in PLAX, VTI from PW Doppler in A5C.', echoKey: 'LVOT area = π × (d/2)². Normal CO 4–8 L/min. CI = CO/BSA, normal >2.2 L/min/m².' },
  { imageCategory: 'effusion', question: 'In a trauma patient, which echo view is used first to rapidly assess for pericardial fluid?', options: ['Subcostal 4-chamber', 'PLAX', 'A4C', 'PSAX'], correct: 0, explanation: '**Subcostal 4-chamber:** Part of the FAST exam. Most sensitive view for detecting pericardial effusion in supine trauma patients.', echoKey: 'FAST cardiac view: subcostal with probe nearly flat on abdomen, marker to patient\'s right. Look for anechoic stripe around heart.' },
  { imageCategory: 'a4c', question: 'What is the normal mitral E/e\' ratio, and what does an elevated ratio suggest?', options: ['Normal <8; elevated >14 suggests high LA pressure', 'Normal >20; low ratio suggests HF', 'Normal 15–20; no clinical significance', 'Normal <2; elevated suggests PE'], correct: 0, explanation: '**E/e\' <8 = normal LAP. E/e\' >14 = elevated LAP.** E/e\' 8–14 is indeterminate and requires additional parameters.', echoKey: 'e\' measured by TDI at septal and lateral mitral annulus. Average E/e\' used. Elevated E/e\' = grade II+ diastolic dysfunction.' },
  { imageCategory: 'a4c', question: 'What does a "rocking" or "swinging heart" motion on echo suggest?', options: ['Large pericardial effusion', 'Normal cardiac motion', 'Constrictive pericarditis', 'Aortic dissection'], correct: 0, explanation: '**Large pericardial effusion:** The heart swings freely within a large effusion, creating alternating electrical axis on ECG (electrical alternans) and rocking motion on echo.', echoKey: 'Swinging heart + electrical alternans + pulsus paradoxus = classic tamponade triad. Urgent pericardiocentesis may be needed.' },
];
